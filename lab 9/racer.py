...
bg = pygame.image.load("lab 8\items\AnimatedStreet.png") # фон игры

# фоновая музыка
pygame.mixer.music.load("lab 8/items/background.wav")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("lab 8\items\Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("lab 8\items\Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('lab 8\items\goldcoin.png')
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound('lab 8/items/crash.wav').play()
        time.sleep(1)
