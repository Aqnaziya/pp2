...
eraser = pygame.transform.scale(pygame.image.load("lab 8\items\eraser.png"), (40, 40))
cleaner = pygame.transform.scale(pygame.image.load("lab 8\items\clean.png"), (40, 40))
pen = pygame.transform.scale(pygame.image.load("lab 8\items\pen.png"), (40, 40))
