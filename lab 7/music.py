...
# Load button images 
button_play_pause_img = pygame.image.load('lab 7/music/play_button.png') 
button_previous_img = pygame.image.load('lab 7/music/previous_button.png') 
button_next_img = pygame.image.load('lab 7/music/next_button.png') 
...
# List of songs 
songs = ['lab 7/music/Иван Дорн - Стыцамен (Не Надо Стесняться) (megapesni.fm).mp3', 'lab 7/music/eyedress-jealous-mp3.mp3','lab 7/music/jah-khalib-911-mp3.mp3'] 
